...
A simple responsive website built using the **Bootslander** template as part of a **Ostad course Module assignment**.  
This project demonstrates the use of **Bootstrap and JavaScrip** to build a clean and mobile-friendly website.
